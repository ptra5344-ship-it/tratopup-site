...
function renderPdf(order: {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Brand lockup
    doc.fillColor(BRAND.primary).font("Helvetica-Bold").fontSize(26).text("TRA", marginX, 44);
    const brandW = doc.widthOfString("TRA");
    doc
      .fillColor("#ffffff")
      .fontSize(26)
    ...
    doc.fillColor("#94a3b8").fontSize(8).text("support: @tratopup on Telegram", marginX, 90);
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(9)
      .text("Telegram: @tratopup", marginX, footerY + 78);
    doc
      .fillColor("#94a3b8")
      .font("Helvetica")
      .fontSize(8)
