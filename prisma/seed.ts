...
async function main() {
  console.log("⚡ Seeding TRATOPUP database...");
  ...
  await prisma.settings.upsert({
    ...
    create: {
      ...
      siteName: "TRATOPUP",
      exchangeRate: 4100,
      supportTelegram: "@tratopup",
      supportEmail: "support@tratopup.com",
    },
  });

  // --- Admin user ---
  const adminEmail = process.env.ADMIN_EMAIL || "admin@tratopup.com";
  ...
  const games = [
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/mlbb.jpg",
      bannerUrl: "https://cdn.tratopup.com/banners/mlbb.jpg",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/freefire.jpg",
      bannerUrl: "https://cdn.tratopup.com/banners/freefire.jpg",
      currencyName: "Diamonds",
      uidLabel: "Player ID",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/pubgm.jpg",
      bannerUrl: "https://cdn.tratopup.com/banners/pubgm.jpg",
      currencyName: "UC",
      uidLabel: "Player ID",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/genshin.jpg",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/hsr.jpg",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.tratopup.com/games/codm.jpg",
      currencyName: "CP",
      uidLabel: "Player ID",
      uidExample: "1234567890",
      sortOrder: 6,
